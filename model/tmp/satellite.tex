...
Nous avons, pour cela, à notre disposition trois jeux de données sous forme de fichiers CVS \footnote{countries2007_all.csv, countries2007_noMissing1.csv, countries2007_noMissing2.csv}. Ces trois fichiers contiennent de nombreuses informations sur un certain nombre de pays. Nous avons restreint notre étude au fichier \og countries2007_noMissing2.cvs \fg qui contient 88 entrées.

En ce qui concerne les outils utilisés, un logiciel de fouille de données
-Outils
